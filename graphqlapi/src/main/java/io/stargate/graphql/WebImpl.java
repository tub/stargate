...
public class WebImpl {
  ...
  public WebImpl(
    ...
    connector.setHost(
        System.getProperty(
            "stargate.graphql_listen_address",
            System.getProperty("stargate.graphql_listen_address")));
    connector.setPort(Integer.parseInt(System.getProperty("stargate.graphql_port", "8080")));
